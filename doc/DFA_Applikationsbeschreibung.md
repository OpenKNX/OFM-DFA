...
der bei Aufruf in Abhängigkeit von einem Logik-Kanal (und ggf. weiteren "Bedingungen Übergängen") den Folgezustand ermittelt, 
oder entscheidet im aktuellen Zustand zu verbleiben.  

*Anmerkung:* Dieser Ansatz ähnelt den Entscheidungs-Pseudozuständen und Bedingungen (Guards) die in UML-Zustandsdiagrammen verwendet werden
...
Der Startzustand kann auch dynamisch durch einen [*bedingten Zustandsübergang*](#bedingte-übergänge-1) bestimmt werden.
Da dies keine Zustandsauswahl garantieren kann, muss in idesem Fall ein "regulärer" Zustand angegeben werden.
...
<!-- DOC Skip="1" -->
 auf der Seite *Zustände & Übergänge*
...
|    (+19) |    1.* | Timeout-Auslöser - Symbol T | Analog *Eingang 1 - Symbol A*                                                                                                                                                                                       |
